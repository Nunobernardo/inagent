              ...
              <div class="row h-100">
                <div class="col-lg-6 col-xs-12 my-auto">
                  <div class="card-title">
                    <h5>Adicionar Treinador</h5>
                  </div>
                </div>
                <div class="col-lg-6 col-xs-12 my-auto">
                  <div class="float-right">
                      <button type="button" onclick="location.href='coaches_list.php'" class="btn btn-primary btn-cons btn-animated from-left pg pg-close">
                        <span>Cancelar</span>
                      </button>
                      <button type="button" class="btn btn-primary btn-cons btn-animated from-left pg pg-save btnSaveCoach">
                        <span>Guardar</span>
                      </button>
                  </div>
                </div>
                ...
                <div class="card card-transparent">
                  <div class="card-body">
                    <form class="" role="form">
                      <div class="form-group form-group-default required ">
                        <label>Nome completo</label>
                        <input type="text" class="form-control txtCoachName" required>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Primeiro nome</label>
                            <input type="text" class="form-control txtCoachFirstName" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Último nome</label>
                            <input type="text" class="form-control txtCoachLastName">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group">
                            <div class="form-input-group disabled">
                              ...
                              <input type="email" class="form-control txtCoachBirth" placeholder="Selecione a data" id="datepicker-component2">
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group form-group-default disabled">
                            <label>Idade</label>
                            <input type="text" class="form-control txtCoachAge">
                          </div>
                        </div>
                      </div>
                      <div class="form-group form-group-default required">
                        <label>Nacionalidade</label>
                        <input type="text" class="form-control txtCoachNationality" required>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group">
                            <div class="form-input-group">
                              <label>Altura</label>
                              <input type="text" class="form-control usd txtCoachHeight" required>
                            </div>
                            <div class="input-group-append ">
                        ...
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group">
                            <div class="form-input-group">
                              <label>Peso</label>
                              <input type="text" class="form-control usd txtCoachWeight" required>
                            </div>
                            <div class="input-group-append ">
                ...
                <div class="card card-transparent">
                  <div class="card-body">
                    <form class="" role="form">
                      ...
                      <div class="form-group form-group-default required ">
                        <label>Clube</label>
                        <input type="txt" class="form-control txtCoachClub" required>
                      </div>
                      <div class="form-group form-group-default input-group">
                        <div class="form-input-group">
                          <label>Valor Mercado</label>
                          <input type="text" class="form-control usd txtCoachValue" required>
                        </div>
                        <div class="input-group-append ">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            ...
                            <input type="text" class="form-control txtCoachPassaport" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group ">
                            <div class="form-input-group">
                              ...
                              <input type="email" class="form-control txtCoachPassaportVal" placeholder="Selecione a data" id="datepicker-component2">
                            </div>
                            <div class="input-group-append ">
                              <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
