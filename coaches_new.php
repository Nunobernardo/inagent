          ...
          <div class=" container-fluid container-fixed-lg ">
            <div class="card-header ">
              <div class="row h-100">
                ...
                <div class="col-lg-6 col-xs-12 my-auto">
                  <div class="float-right">
                      <button type="button" onclick="location.href='coaches_list.php'" class="btn2 btn-primary btn-cons btn-animated from-left pg pg-close">
                        <span>Cancelar</span>
                      </button>
                      <button type="button" class="btn2 btn-primary btn-cons btn-animated from-left pg pg-save btnSaveCoach">
                        <span>Guardar</span>
                      </button>
                  </div>
                </div>
                      ...
                      <div class="form-group form-group-default required ">
                        ...
                        <form role="form">
                          <div class="form-group ">
                            <select class="full-width ddlCoachClub" data-init-plugin="select2"></select>
                          </div>
                        </form>
                      </div>
                      <div class="form-group form-group-default input-group">
