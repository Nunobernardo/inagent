                  ...
                  <div class="container-xs-height full-height">
                    <div class="row-xs-height">
                      <div class="modal-body col-xs-height col-middle">
                        ...
                        <br>
                        <button type="button" onclick="location.href='mandates_list.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-save">
                          <span>Guardar</span>
                        </button>
                        <button type="button" onclick="location.href='mandates_list.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-close">
                          <span>Cancelar</span>
                        </button>
                      </div>
                    </div>
                ...
                <div class="row h-100">
                  <div class="col-lg-6 col-xs-12 my-auto">
                    <div class="card-title">
                      <h5>Lista de Mandatos</h5>
                    </div>
                  </div>
                  <div class="col-lg-6 col-xs-12 my-auto">
                    <div class="float-right">
                        <button type="button" onclick="location.href='mandates_new.php'" class="btn2 btn-primary btn-cons btn-animated from-left pg pg-close">
                          <span>Adicionar</span>
                        </button>
                    </div>
                  </div>
