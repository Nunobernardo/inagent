                ...
                <div class="row h-100">
                  <div class="col-lg-6 col-xs-12 my-auto">
                    <div class="card-title">
                      <h5>Lista de Treinadores</h5>
                    </div>
                  </div>
                  <div class="col-lg-6 col-xs-12 my-auto">
                    <div class="float-right">
                        <button type="button" onclick="location.href='coaches_new.php'" class="btn2 btn-primary btn-cons btn-animated from-left pg pg-close">
                          <span>Adicionar</span>
                        </button>
                    </div>
                  </div>
                  ...
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th style="width:17%; text-align: center; vertical-align: middle;">Formação preferida</th>
                      ...
                      <tbody role="row" class="row_coach"  style="width:20%; text-align: center; vertical-align: middle;"></tbody>
                  </table>
                </div>
              </div>
            </div>
