                    ...
                    <form class="" role="form">
                      ...
                      <div class="col-lg-12 col-xs-12 my-auto">
                        <div class="float-left">
                          <div class="btn-group">
                            <button type="button" style="margin-bottom: 15px; margin-right:10px;" class="btn3 btn-primary addNewPlayer" data-target="#modalSlideLeftNew" data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Adicionar"><i class="fa fa-plus"></i>
                            </button>
                            <button type="button" style="margin-bottom: 15px;" class="btn3 btn-primary editPlayer" data-target="#modalSlideLeftEdit" data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa fa-pencil"></i>
                            </button>
                          </div>
                        </div>
                      </div>
                      <div class="card card-default">
                        ...
                        <div class="card-body">
                          <select class="full-width ddlRepresentationPlayer" style="z-index: auto;" data-init-plugin="select2">
                          </select> 
                        </div>
                      </div>
                      <div class="row">
