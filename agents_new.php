                  ...
                  <div class="container-xs-height full-height">
                    <div class="row-xs-height">
                      <div class="modal-body col-xs-height col-middle">
                        ...
                        <br>
                        <button type="button" onclick="location.href='agents_new.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-save">
                          <span>Guardar</span>
                        </button>
                        <button type="button" onclick="location.href='agents_new.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-close">
                          <span>Cancelar</span>
                        </button>
                      </div>
                    </div>
                ...
                <div class="card card-transparent">
                  <div class="card-body">
                    <form class="" role="form">
                      <div class="form-group form-group-default required ">
                        <label>Nome completo</label>
                        <input type="text" class="form-control txtAgentName" required>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Primeiro nome</label>
                            <input type="text" class="form-control txtAgentFirstName" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Último nome</label>
                            <input type="text" class="form-control txtAgentLastName">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group ">
                            <div class="form-input-group disabled">
                              ...
                              <input type="email" class="form-control txtAgentBirth" placeholder="Selecione a data" id="datepicker-component2">
                            </div>
                      ...
                      <div class="form-group form-group-default required">
                        ...
                        <input type="text" class="form-control txtAgentNationality" required>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>CC/Passaporte</label>
                            <input type="text" class="form-control txtAgentDocuments" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group form-group-default input-group">
                            <div class="form-input-group">
                              ...
                              <input type="email" class="form-control txtAgentDocumentsVal" placeholder="Selecione a data" id="datepicker-component2">
                            </div>
                            <div class="input-group-append ">
                              <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                  ...
                  <div class="card-body">
                    <form class="" role="form">
                      ...
                      <div class="form-group form-group-default required">
                        ...
                        <input type="text" class="form-control txtAgentContacts" required>
                      </div>
                      <div class="form-group form-group-default required">
                        <label>Observações</label>
                        <input type="text" class="form-control txtAgentObs" required>
                      </div>
                    </form>
                  </div>
                </div>
