                  ...
                  <div class="container-xs-height full-height">
                    <div class="row-xs-height">
                      <div class="modal-body col-xs-height col-middle">
                        ...
                        <br>
                        <button type="button" onclick="location.href='agents_list.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-save">
                          <span>Guardar</span>
                        </button>
                        <button type="button" onclick="location.href='agents_list.php'" class="btn btn-primary btn-block btn-animated from-left pg pg-close">
                          <span>Cancelar</span>
                        </button>
                      </div>
                    </div>
            ...
            <div class="card card-transparent">
              <div class="card-header ">
                <div class="row h-100">
                  ...
                  <div class="col-lg-6 col-xs-12 my-auto">
                    <div class="float-right">
                        <button type="button" onclick="location.href='agents_new.php'" class="btn2 btn-primary btn-cons btn-animated from-left pg pg-close">
                          <span>Adicionar</span>
                        </button>
                    </div>
                  </div>
                  ...
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th style="width:15%; text-align: center; vertical-align: middle;">Empresa</th>
                        ...
                        <th style="width:13%; text-align: center; vertical-align: middle;">Contactos</th>
                      </tr>
                    </thead>
                    <tbody role="row" class="row_agent" style="width:20%; text-align: center; vertical-align: middle;"></tbody>
                  </table>
                </div>
              </div>
            </div>
